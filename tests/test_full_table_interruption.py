    ...
    def test_catalog(self):
        ...
        try:
            tap_postgres.do_sync(
                get_test_connection_config(), {"streams": streams}, None, state
            )
        except Exception:
            blew_up_on_cow = True
        ...
        self.assertIsNone(
            CAUGHT_MESSAGES[1].value["bookmarks"]["public-COW"].get("xmin")
        )
        self.assertIsNotNone(
            CAUGHT_MESSAGES[1].value["bookmarks"]["public-COW"].get("lsn")
        )
        ...
        self.assertIsNotNone(
            CAUGHT_MESSAGES[4].value["bookmarks"]["public-COW"]["xmin"]
        )
        self.assertEqual(
            CAUGHT_MESSAGES[4].value["bookmarks"]["public-COW"]["lsn"], end_lsn
        )

        self.assertEqual(
            CAUGHT_MESSAGES[5].record,
            {
                "colour": "brow",
                "id": 2,
                "name": "smelly",
        ...
        CAUGHT_MESSAGES.clear()
        tap_postgres.do_sync(
            get_test_connection_config(), {"streams": streams}, None, old_state
        )
        ...
        self.assertIsInstance(CAUGHT_MESSAGES[1], singer.StateMessage)
        self.assertEqual(
            CAUGHT_MESSAGES[1].value["bookmarks"]["public-COW"].get("xmin"), last_xmin
        )
        self.assertEqual(
            CAUGHT_MESSAGES[1].value["bookmarks"]["public-COW"].get("lsn"), end_lsn
        )
        self.assertEqual(
            CAUGHT_MESSAGES[1].value["bookmarks"]["public-COW"].get("version"),
            new_version,
        )

        self.assertIsInstance(CAUGHT_MESSAGES[2], singer.RecordMessage)
        self.assertEqual(
            CAUGHT_MESSAGES[2].record,
            {
                "colour": "brow",
                "id": 2,
                "name": "smelly",
        ...
        self.assertTrue(
            CAUGHT_MESSAGES[3].value["bookmarks"]["public-COW"].get("xmin"), last_xmin
        )
        self.assertEqual(
            CAUGHT_MESSAGES[3].value["bookmarks"]["public-COW"].get("lsn"), end_lsn
        )
        self.assertEqual(
            CAUGHT_MESSAGES[3].value["bookmarks"]["public-COW"].get("version"),
            new_version,
        )

        self.assertIsInstance(CAUGHT_MESSAGES[4], singer.RecordMessage)
        self.assertEqual(
            CAUGHT_MESSAGES[4].record,
            {
                "colour": "green",
                "id": 3,
                "name": "pooper",
        ...
        self.assertTrue(
            CAUGHT_MESSAGES[5].value["bookmarks"]["public-COW"].get("xmin") > last_xmin
        )
        self.assertEqual(
            CAUGHT_MESSAGES[5].value["bookmarks"]["public-COW"].get("lsn"), end_lsn
        )
        self.assertEqual(
            CAUGHT_MESSAGES[5].value["bookmarks"]["public-COW"].get("version"),
            new_version,
        )
        ...
        self.assertIsNone(
            CAUGHT_MESSAGES[7].value["bookmarks"]["public-COW"].get("xmin")
        )
        self.assertEqual(
            CAUGHT_MESSAGES[7].value["bookmarks"]["public-COW"].get("lsn"), end_lsn
        )
        self.assertEqual(
            CAUGHT_MESSAGES[7].value["bookmarks"]["public-COW"].get("version"),
            new_version,
        )
...
class FullTableInterruption(unittest.TestCase):
    ...
    def test_catalog(self):
        ...
        self.assertIsInstance(CAUGHT_MESSAGES[1], singer.StateMessage)
        self.assertIsNone(
            CAUGHT_MESSAGES[1].value["bookmarks"]["public-CHICKEN"].get("xmin")
        )
        ...
        # xmin is set while we are processing the full table replication
        self.assertIsNotNone(
            CAUGHT_MESSAGES[4].value["bookmarks"]["public-CHICKEN"]["xmin"]
        )
        ...
        self.assertIsNone(
            CAUGHT_MESSAGES[6].value["bookmarks"]["public-CHICKEN"]["xmin"]
        )
        ...
        self.assertIsNone(
            CAUGHT_MESSAGES[8].value["bookmarks"]["public-COW"].get("xmin")
        )
        ...
        # xmin is set while we are processing the full table replication
        self.assertIsNotNone(
            CAUGHT_MESSAGES[11].value["bookmarks"]["public-COW"]["xmin"]
        )
        ...
        self.assertEqual(
            CAUGHT_MESSAGES[1].value["bookmarks"]["public-COW"]["version"], cow_version
        )
        self.assertIsNotNone(
            CAUGHT_MESSAGES[1].value["bookmarks"]["public-COW"]["xmin"]
        )
        self.assertEqual(
            "public-COW", singer.get_currently_syncing(CAUGHT_MESSAGES[1].value)
        )
        ...
        self.assertIsNotNone(
            CAUGHT_MESSAGES[3].value["bookmarks"]["public-COW"]["xmin"]
        )
        self.assertEqual(
            singer.get_currently_syncing(CAUGHT_MESSAGES[3].value), "public-COW"
        )
        ...
        self.assertIsInstance(CAUGHT_MESSAGES[5], singer.StateMessage)
        self.assertIsNotNone(
            CAUGHT_MESSAGES[5].value["bookmarks"]["public-COW"]["xmin"]
        )
        self.assertEqual(
            singer.get_currently_syncing(CAUGHT_MESSAGES[5].value), "public-COW"
        )
        ...
        self.assertIsNone(
            CAUGHT_MESSAGES[7].value["bookmarks"]["public-CHICKEN"]["xmin"]
        )
        self.assertIsNone(singer.get_currently_syncing(CAUGHT_MESSAGES[7].value))
